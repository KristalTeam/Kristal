...
function Virovirokun:getCheckText(battler)
    ...
    if self.nb_checks == 3 and #Game.battle.party >= 2 then
        table.insert(text, "* "..Game.battle.party[2].chara:getName().." tells you to stop cheking.")
    elseif self.nb_checks == 4 and #Game.battle.party >= 3 then
        table.insert(text, "* "..Game.battle.party[3].chara:getName().." begs you to stop cheking!")
