...
function MouseHole:startTalk(talk)
    ...
    elseif talk == "Together" then
        self:startDialogue({"[emote:left_talk]* U-us? [wait:5]No, [wait:5]we're not... [wait:5]I-I mean, [wait:5]there's not much goin' for me.", "[emote:talk]* That's all!!"})
    end
end
