...
CoinBowl = require("src.engine.game.world.events.climbing.coinbowl")
...
FightButton = require("src.engine.game.battle.ui.buttons.fightbutton")
ActButton = require("src.engine.game.battle.ui.buttons.actbutton")
MagicButton = require("src.engine.game.battle.ui.buttons.magicbutton")
ItemButton = require("src.engine.game.battle.ui.buttons.itembutton")
DefendButton = require("src.engine.game.battle.ui.buttons.defendbutton")
SpareButton = require("src.engine.game.battle.ui.buttons.sparebutton")
