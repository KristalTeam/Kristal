...
EditorEvent = require("src.engine.editor.editorevent")
EditorPlayer = require("src.engine.editor.events.player")
EditorMarker = require("src.engine.editor.events.marker")
EditorPath = require("src.engine.editor.events.path")
EditorTileObject = require("src.engine.editor.events.tileobject")
EditorSavepoint = require("src.engine.editor.events.savepoint")
EditorInteractable = require("src.engine.editor.events.interactable")
EditorScriptEvent = require("src.engine.editor.events.script")
EditorTransition = require("src.engine.editor.events.transition")
EditorNPC = require("src.engine.editor.events.npc")
EditorChaserEnemy = require("src.engine.editor.events.chaserenemy")
EditorOutline = require("src.engine.editor.events.outline")
EditorSilhouette = require("src.engine.editor.events.silhouette")
EditorSlideArea = require("src.engine.editor.events.slidearea")
EditorMirrorArea = require("src.engine.editor.events.mirror")
EditorTreasureChest = require("src.engine.editor.events.treasurechest")
EditorCameraTarget = require("src.engine.editor.events.cameratarget")
EditorHideParty = require("src.engine.editor.events.hideparty")
EditorSetFlagEvent = require("src.engine.editor.events.setflagevent")
EditorCyberTrashCan = require("src.engine.editor.events.cybertrashcan")
EditorForcefield = require("src.engine.editor.events.forcefield")
EditorPushBlock = require("src.engine.editor.events.pushblock")
EditorTileButton = require("src.engine.editor.events.tilebutton")
EditorMagicGlass = require("src.engine.editor.events.magicglass")
EditorWarpDoor = require("src.engine.editor.events.warpdoor")
EditorDarkFountain = require("src.engine.editor.events.darkfountain")
EditorFountainFloor = require("src.engine.editor.events.fountainfloor")
EditorQuicksave = require("src.engine.editor.events.quicksave")
EditorSpriteEvent = require("src.engine.editor.events.sprite")
EditorClimbEntry = require("src.engine.editor.events.climbing.climbentry")
EditorClimbExit = require("src.engine.editor.events.climbing.climbexit")
EditorClimbLanding = require("src.engine.editor.events.climbing.climblanding")
EditorClimbArea = require("src.engine.editor.events.climbing.climbarea")
EditorFallingClimbArea = require("src.engine.editor.events.climbing.fallingclimbarea")
EditorClimbUnsafe = require("src.engine.editor.events.climbing.climbunsafe")
EditorClimbMover = require("src.engine.editor.events.climbing.climbmover")
EditorToggleController = require("src.engine.editor.events.controllers.toggle")
EditorFountainShadowController = require("src.engine.editor.events.controllers.fountainshadow")
...
EditorEventBrowser = require("src.engine.editor.panels.eventbrowser")
