...
MapUtils = require("src.utils.maputils")
TiledUtils = require("src.utils.tiledutils")
FileSystemUtils = require("src.utils.filesystemutils")
ProjectFileSystem = require("src.utils.projectfilesystem")
...
TilesetReader = require("src.engine.game.world.readers.tilesetreader")
TiledTilesetReader = require("src.engine.game.world.readers.tiledtilesetreader")
EditorTilesetReader = require("src.engine.game.world.readers.editortilesetreader")
...
EditorMapExporter = require("src.engine.editor.editormapexporter")
...
EditorChoiceUtils = require("src.engine.editor.editorchoiceutils")
...
EditorWorld = require("src.engine.editor.editorworld")
EditorHistory = require("src.engine.editor.editorhistory")
EditorCommandRegistry = require("src.engine.editor.editorcommandregistry")
EditorWorkspaceRegistry = require("src.engine.editor.editorworkspaceregistry")
EditorDocument = require("src.engine.editor.editordocument")
EditorDocumentProvider = require("src.engine.editor.editordocumentprovider")
EditorDocumentProviders = require("src.engine.editor.editordocumentproviders")
EditorToolRegistry = require("src.engine.editor.editortoolregistry")
EditorDrawFX = require("src.engine.editor.editordrawfx")
EditorPropertyFields = require("src.engine.editor.editorpropertyfields")
EditorTilesetDocument = require("src.engine.editor.editortilesetdocument")
EditorFormatDocument = require("src.engine.editor.editorformatdocument")
EditorPropertyGroup = require("src.engine.editor.editorpropertygroup")
EditorPropertySet = require("src.engine.editor.editorpropertyset")
EditorPropertyRegistry = require("src.engine.editor.editorpropertyregistry")
TerrainRuleContext = require("src.engine.editor.terrainrulecontext")
TerrainRuleRegistry = require("src.engine.editor.terrainruleregistry")
EditorObject = require("src.engine.editor.editorobject")
EditorLegacyObject = require("src.engine.editor.objects.legacy")
EditorPlayer = require("src.engine.editor.objects.player")
EditorMarker = require("src.engine.editor.objects.marker")
EditorPath = require("src.engine.editor.objects.path")
EditorTileObject = require("src.engine.editor.objects.tileobject")
EditorSavepoint = require("src.engine.editor.objects.savepoint")
EditorInteractable = require("src.engine.editor.objects.interactable")
EditorScriptObject = require("src.engine.editor.objects.script")
EditorTransition = require("src.engine.editor.objects.transition")
EditorNPC = require("src.engine.editor.objects.npc")
EditorChaserEnemy = require("src.engine.editor.objects.chaserenemy")
EditorOutline = require("src.engine.editor.objects.outline")
EditorSilhouette = require("src.engine.editor.objects.silhouette")
EditorSlideArea = require("src.engine.editor.objects.slidearea")
EditorMirrorArea = require("src.engine.editor.objects.mirror")
EditorTreasureChest = require("src.engine.editor.objects.treasurechest")
EditorCameraTarget = require("src.engine.editor.objects.cameratarget")
EditorHideParty = require("src.engine.editor.objects.hideparty")
EditorSetFlagObject = require("src.engine.editor.objects.setflag")
EditorCyberTrashCan = require("src.engine.editor.objects.cybertrashcan")
EditorForcefield = require("src.engine.editor.objects.forcefield")
EditorPushBlock = require("src.engine.editor.objects.pushblock")
EditorTileButton = require("src.engine.editor.objects.tilebutton")
EditorMagicGlass = require("src.engine.editor.objects.magicglass")
EditorWarpDoor = require("src.engine.editor.objects.warpdoor")
EditorDarkFountain = require("src.engine.editor.objects.darkfountain")
EditorFountainFloor = require("src.engine.editor.objects.fountainfloor")
EditorQuicksave = require("src.engine.editor.objects.quicksave")
EditorSpriteObject = require("src.engine.editor.objects.sprite")
EditorClimbEntry = require("src.engine.editor.objects.climbing.climbentry")
EditorClimbExit = require("src.engine.editor.objects.climbing.climbexit")
EditorClimbLanding = require("src.engine.editor.objects.climbing.climblanding")
EditorClimbArea = require("src.engine.editor.objects.climbing.climbarea")
EditorFallingClimbArea = require("src.engine.editor.objects.climbing.fallingclimbarea")
EditorClimbUnsafe = require("src.engine.editor.objects.climbing.climbunsafe")
EditorClimbMover = require("src.engine.editor.objects.climbing.climbmover")
EditorToggleController = require("src.engine.editor.objects.controllers.toggle")
EditorFountainShadowController = require("src.engine.editor.objects.controllers.fountainshadow")
EditorLayerOverlay = require("src.engine.editor.editorlayeroverlay")
EditorControl = require("src.engine.editor.ui.control")
EditorTooltip = require("src.engine.editor.ui.tooltip")
EditorTextInput = require("src.engine.editor.ui.controls.textinput")
EditorTileLayoutInput = require("src.engine.editor.ui.controls.tilelayoutinput")
EditorCodeBuffer = require("src.engine.editor.codebuffer")
EditorLuaHighlighter = require("src.engine.editor.luahighlighter")
EditorFileTypeRegistry = require("src.engine.editor.filetyperegistry")
EditorImageDocument = require("src.engine.editor.imagedocument")
EditorImagePreview = require("src.engine.editor.ui.controls.imagepreview")
EditorSourceInput = require("src.engine.editor.ui.controls.sourceinput")
EditorTableInput = require("src.engine.editor.ui.controls.tableinput")
EditorButton = require("src.engine.editor.ui.controls.button")
EditorColorInput = require("src.engine.editor.ui.controls.colorinput")
EditorPathInput = require("src.engine.editor.ui.controls.pathinput")
EditorPathListInput = require("src.engine.editor.ui.controls.pathlistinput")
EditorColorPicker = require("src.engine.editor.ui.colorpicker")
EditorPathPicker = require("src.engine.editor.ui.pathpicker")
EditorObjectReferencePicker = require("src.engine.editor.ui.objectreferencepicker")
EditorCreationDialog = require("src.engine.editor.ui.creationdialog")
EditorCheckbox = require("src.engine.editor.ui.controls.checkbox")
EditorToggle = require("src.engine.editor.ui.controls.toggle")
EditorObjectReferenceControl = require("src.engine.editor.ui.controls.objectreference")
EditorToolButton = require("src.engine.editor.ui.controls.toolbutton")
...
EditorPropertiesPanel = require("src.engine.editor.panels.properties")
EditorSettingsPanel = require("src.engine.editor.panels.settings")
EditorFileDocument = require("src.engine.editor.filedocument")
EditorProjectWorkspace = require("src.engine.editor.projectworkspace")
EditorFileBrowser = require("src.engine.editor.panels.filebrowser")
EditorSourceViewer = require("src.engine.editor.panels.sourceviewer")
EditorSourceDocumentProvider = require("src.engine.editor.sourcedocumentprovider")
...
EditorZoomUtils = require("src.engine.editor.editorzoomutils")
...
EditorWorldBrowser = require("src.engine.editor.panels.worldbrowser")
EditorObjectBrowser = require("src.engine.editor.panels.objectbrowser")
EditorTilesetBrowser = require("src.engine.editor.panels.tilesetbrowser")
EditorTilePalette = require("src.engine.editor.panels.tilepalette")
EditorTerrainPalette = require("src.engine.editor.panels.terrainpalette")
EditorTilesetPanel = require("src.engine.editor.panels.tileset")
EditorLayersPanel = require("src.engine.editor.panels.layers")
EditorFXBrowser = require("src.engine.editor.panels.fxbrowser")
EditorToolbar = require("src.engine.editor.panels.toolbar")
EditorDiagnosticsPanel = require("src.engine.editor.panels.diagnostics")
EditorConsolePanel = require("src.engine.editor.panels.console")
...
EditorPlugin = require("src.engine.editor.editorplugin")
