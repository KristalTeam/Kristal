return {
    ...
    animations = {
        ...
        ["battle/transition"]   = {"world/dark_bangs/right_1", 1/15, false},
    ...
    offsets = {
        ["world/dark_bangs/down"] = {0, 2},
        ["world/dark_bangs/left"] = {0, 2},
        ["world/dark_bangs/right"] = {0, 2},
        ["world/dark_bangs/up"] = {0, 2},
