        ...
        local inner = Component(0, 0, FillSizing(), FitSizing())
            ...
            local box = BoxComponent(0, 0, FitSizing())
                local menu = EasingSoulMenuComponent(0, 0, FitSizing(), FixedSizing(240))
                    ...
                    menu:addChild(SoulMenuItemComponent(Text("Option 6"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 7"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 8"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 9"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 10"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 11"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 12"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 13"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 14"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 15"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 16"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 17"), function() end))
                    menu:addChild(SoulMenuItemComponent(Text("Option 18"), function() end))
