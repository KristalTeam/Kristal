    ...
    local outer = Component(0, 0, FixedSizing(640, 480))
        ...
        local inner = Component(0, 0, FillSizing(), FitSizing())
            ...
            local box = BoxComponent(0, 0, FitSizing())
                local menu = EasingSoulMenuComponent(0, 0, FitSizing(), FixedSizing(240))
                    ...
                    menu:addChild(ArrowListMenuItemComponent({ "List Option 1", "List Option 2", "List Option 300" }, 1, function(value) end))
                    menu:addChild(TextMenuItemComponent(Text("Option 3"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 3"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 4"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 5"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 6"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 7"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 8"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 9"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 10"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 11"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 12"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 13"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 14"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 15"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 16"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 17"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 18"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 19"), function() end))
                    menu:addChild(TextMenuItemComponent(Text("Option 20"), function() end))
