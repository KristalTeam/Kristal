...
KRISTAL_EVENT = {
    ...
    onRegisterEditorObjects = "onRegisterEditorObjects", -- default editor objects registered; libraries and the mod can register theirs / in: Registry.initEditorObjects() / passes: NONE / returns: NONE
