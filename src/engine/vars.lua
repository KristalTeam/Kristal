...
KRISTAL_EVENT = {
    ...
    unload = "unload", -- current game execution is stopped and data unloaded / at: Kristal.clearModState()\Kristal.errorHandler(msg, trace_level) / passes: error:boolean / returns: NONE
