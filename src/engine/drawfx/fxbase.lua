...
---@class FXBase : Class
---
---@field id string Identifier for this FX
---@field parent Object Object this FX is attached to
---@field priority number Higher number = higher priority (processed last)
---@field active boolean Whether this FX should be processed
---@field transformed boolean Whether this FX should be transformed by the object (scaled, rotated, etc)
---
---@overload fun(...) : FXBase
local FXBase = Class()

FXBase.SORTER = function(a, b)
    return (a.transformed and not b.transformed) or (a.transformed == b.transformed and a.priority > b.priority)
end
...
function FXBase:getObjectBounds(shader)
    if not self.transformed then
        ...
        return SCREEN_WIDTH / 2 - (self.parent.width / 2), SCREEN_HEIGHT / 2 - (self.parent.height / 2),
