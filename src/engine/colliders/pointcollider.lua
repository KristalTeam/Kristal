...
function PointCollider:init(parent, x, y)
...
function PointCollider:collidesWith(other)
    ...
    elseif other:includes(LineCollider) then
        return CollisionUtil.pointLine(self.x,self.y, other:getShapeFor(self))
    elseif other:includes(CircleCollider) then
        return CollisionUtil.pointCircle(self.x,self.y, other:getShapeFor(self))
    elseif other:includes(PointCollider) then
        return CollisionUtil.pointPoint(self.x,self.y, other:getShapeFor(self))
    elseif other:includes(PolygonCollider) then
        return CollisionUtil.pointPolygon(self.x,self.y, other:getShapeFor(self))
