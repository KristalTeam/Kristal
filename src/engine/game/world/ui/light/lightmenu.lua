...
function LightMenu:draw()
    ...
    Draw.print(chara:getName(), 46, 60 + offset)

    love.graphics.setFont(self.font_small)
    Draw.print("LV  "..chara:getLightLV(), 46, 100 + offset)
    Draw.print("HP  "..chara:getHealth().."/"..chara:getStat("health"), 46, 118 + offset)
    Draw.print(Utils.padString(Game:getConfig("lightCurrencyShort"), 4)..Game.lw_money, 46, 136 + offset)
    ...
    Draw.print("ITEM", 84, 188 + (36 * 0))
    Draw.setColor(PALETTE["world_text"])
    Draw.print("STAT", 84, 188 + (36 * 1))
