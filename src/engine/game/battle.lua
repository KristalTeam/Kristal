    ...
    elseif action.action == "ATTACK" or action.action == "AUTOATTACK" then
        ...
        battler:setAnimation("battle/attack", function()
            ...
            if damage > 0 then
                ...
                dmg_sprite.onRemove = function() Utils.removeFromTable(enemy.dmg_sprites, dmg_sprite) end -- Remove the dmg_sprite from the enemy's dmg_sprite table when its removed
