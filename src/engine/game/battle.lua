    ...
    elseif action.action == "ATTACK" or action.action == "AUTOATTACK" then
        ...
        battler:setAnimation("battle/attack", function()
            ...
            if damage > 0 then
                ...
                local relative_pos = enemy:getRelativePos(enemy.width/2, enemy.height/2)
                local dmg_sprite_offset = enemy.dmg_sprite_offset
                dmg_sprite:setPosition(relative_pos[1]+dmg_sprite_offset[1],relative_pos[2]+dmg_sprite_offset[2])
