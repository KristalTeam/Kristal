...
function MainMenuModConfig:registerOptions()
    ...
    self:registerOption("oldSpareText", "Old Spare Text", "Determines if unsuccessful spare attempt points out the enemy's name not being yellow or their mercy not being 100%", "selection", { nil, true, false })
