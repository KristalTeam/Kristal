...
function MainMenuModConfig:registerOptions()
    ...
    self:registerOption("growStronger",           "Grow Stronger",             "Stat increases after defeating an enemy with violence",                              "selection", {nil, true, false, "Any"})
    self:registerOption("growStrongerChara",      "Grow Stronger Character",   "The character who grows stronger if they're in the party",                           "selection", {nil, "kris", "ralsei", "susie", "noelle", false}) -- unhardcode
