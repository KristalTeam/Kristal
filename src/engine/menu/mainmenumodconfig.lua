...
function MainMenuModConfig:registerOptions()
    ...
    self:registerOption("tiredMessages",          "Tired Messages",            "Whether a TIRED/Awake message should appear when an enemy changes TIRED states",     "selection", {nil, true, false})
